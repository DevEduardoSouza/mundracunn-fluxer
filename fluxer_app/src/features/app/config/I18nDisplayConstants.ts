...
// A pagina oficial fluxer.app/download manda o Android para o GitHub do
// flutter_client (listagem de codigo), que foi onde o cliente se perdeu
// (relato de 21/08). O dominio proprio serve uma pagina simples com o APK
// hospedado localmente (nginx, /opt/mundracunn/apk, timer mundracunn-apk).
export const DESKTOP_DOWNLOAD_URL =
	Config.PUBLIC_RELEASE_CHANNEL === 'canary'
		? 'https://canary.fluxer.app/download'
		: 'https://comunidademundracunn.com/download';
